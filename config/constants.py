...
FIELD_CLASS_SESSION_NUMBERS: str = os.getenv("VECTORDB_FIELD_CLASS_SESSION_NUMBERS", "class_session_numbers")
FIELD_COURSE_SESSIONS: str = os.getenv("VECTORDB_FIELD_COURSE_SESSIONS", "course_sessions")
